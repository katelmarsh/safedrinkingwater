...
filt_weather <- tx_weather[tx_weather$EVENT_TYPE == c("Flash Flood","Hurricane","Coastal Flood", "Flood", "Storm Surge/Tide", "Heavy Rain", "Hurricane (Typhoon)", "Tropical Storm", "Tropical Depression", "THUNDERSTORM WINDS/ FLOOD")]
